<template>
    <nav class="navbar is-dark" role="navigation" aria-label="main navigation">
        <div class="navbar-brand">
            <router-link exact active-class="none" class="navbar-item navbar-text" :to="{ name: 'welcome' }">
                <svg class="mr-2 has-text-white" style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                Facilities Learning Management
            </router-link>
...
<!--            <div class="navbar-start grow-1 justify-center">-->
<!--                <b-input class="navbar-item" placeholder="Search"></b-input>-->
<!--            </div>-->

<!--            <div class="navbar-end">-->
<!--                <div class="navbar-item">-->
<!--                    <template v-if="authenticated">-->
<!--                        <router-link v-if="isA('admin')" class="button ml-2" :to="{ name: 'home' }">-->
<!--                            Admin Panel-->
<!--                        </router-link>-->
<!--                    </template>-->
<!--                </div>-->
